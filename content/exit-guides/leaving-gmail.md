...
hero:
  ...
  titleLine1: Leave
  titleLine2: Gmail
  standfirst: "Fifteen years of your correspondence, read by an advertising machine. Here is the door — and here is what waits on the **other side**."
...
altsIntro: "Two providers that treat your mail as correspondence, not raw material. Both import from Gmail; both work the day you arrive."
alternatives:
  - name: Proton Mail
    tagline: "Encrypted Mail · Geneva"
    rank: "[001] Recommended First Move"
    description: "Swiss-based and end-to-end encrypted by default. Your inbox is a locked room even Proton cannot enter — and Easy Switch pulls your Gmail archive across in one pass."
    difficulty: 2
  ...
  - name: Tuta
    ...
    description: "German encrypted mail with a fully open-source client and a green-power promise. Calendar and contacts are encrypted alongside the inbox, so nothing leaks out the side."
    difficulty: 3
    ctaLabel: Make The Switch
